...
namespace SpriteLightRendering
{
    ...
    public class SpriteLightRendererData : ScriptableRendererData
    {
#if UNITY_EDITOR
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1812")]
        internal class CreateSpriteLightRendererAsset : EndNameEditAction
        {
        ...
        [MenuItem("Assets/Create/Rendering/Sprite Light Rendering/Sprite Light Renderer", priority = CoreUtils.assetCreateMenuPriority2)]
        static void CreateSpriteLightRendererData()
        {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, CreateInstance<CreateSpriteLightRendererAsset>(), "CustomSpriteLightRendererData.asset", null, null);
        }
#endif
...
#endif
            return new SpriteLightRenderer(this);
        }
